...
e1000_init(uint32 *xregs)
{
  ...
  // Reset the device
  // 重置设备
  regs[E1000_IMS] = 0; // disable interrupts 关闭中断
  regs[E1000_CTL] |= E1000_CTL_RST;
  regs[E1000_IMS] = 0; // redisable interrupts 重新打开中断
  __sync_synchronize();
  ...
  // [E1000 14.4] Receive initialization 接收初始化
  ...
  // 过滤掉不是52:54:00:12:34:56这个mac 地址的包
  ...
  // 叫 e1000 收到包就发起中断
  regs[E1000_RDTR] = 0; // interrupt after every received packet (no timer) 收到包就发起中断，（没有延迟）
